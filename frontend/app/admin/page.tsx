...
export default async function AdminPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-gray-50 py-12 dark:bg-zinc-900">
      <div className="w-full max-w-6xl space-y-8 rounded-xl bg-white p-10 shadow-lg dark:bg-zinc-800">
        <div className="flex items-center justify-between border-b border-gray-200 pb-6 dark:border-gray-700">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
              Administrator tools and operations
            </p>
          </div>
        </div>
        <AdminDashboard idToken={session.idToken} />
      </div>
    </div>
  );
}

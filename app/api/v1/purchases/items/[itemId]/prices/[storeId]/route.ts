...
type Params = { params: Promise<{ itemId: string; storeId: string }> };

// PUT /api/v1/purchases/items/[itemId]/prices/[storeId] - 価格更新（なければ作成）
export async function PUT(request: Request, { params }: Params) {
  const { itemId, storeId } = await params;
...
// DELETE /api/v1/purchases/items/[itemId]/prices/[storeId] - 価格削除
